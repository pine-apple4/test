...
const quizQuestions = [
    ...
    {
        question:
        "30초 후 오토라디오그램에서 3초 후보다 방사성 탄소가 검출되는 물질의 종류가 많아진 이유는 무엇일까요?",
        options:[
            "빛의 세기가 강해졌기 때문에",
            "시간이 지나며 방사성 탄소가 여러 물질로 옮겨갔기 때문에",
            "CO₂ 농도가 낮아졌기 때문에",
            "온도가 올라갔기 때문에"
        ],
        answer:1,
    ...
    {
        question:
        "이 실험(캘빈의 방사성 동위원소 추적 실험)이 보여 주는 것은 무엇인가요?",
        options:[
            "광합성에서 물이 분해되는 순서",
            "빛에너지가 열에너지로 바뀌는 과정",
            "캘빈 회로에서 탄소가 고정되어 여러 물질로 이동하는 경로",
            "엽록소가 빛을 흡수하는 파장 범위"
        ],
        answer:2,
        explain:
        "캘빈은 시간에 따라 방사성 탄소가 검출되는 물질을 추적해, 탄소가 캘빈 회로를 거쳐 여러 유기물로 이동하는 경로를 밝혀냈습니다."
    }
];
